...
public class TestClass {
	...
	public void setUp() throws Exception{
		...
		Customer cust1=new Customer("Shravya", "9866837576",new Wallet(new BigDecimal(9000)));
		Customer cust2=new Customer("Sravanthi", "9491955395",new Wallet(new BigDecimal(6000)));
		Customer cust3=new Customer("Sushma", "9652665470",new Wallet(new BigDecimal(7000)));
	...
	public void testCreateAccount6() {
		service.createAccount("Shravya", "9866837576", new BigDecimal(-100));
	}
	@Test
